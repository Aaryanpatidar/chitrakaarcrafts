...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section style={heroStyles.section}>
        ...
        <div style={heroStyles.content}>
          ...
          <div style={heroStyles.btns}>
            ...
            <Link to="/products?category=Painting" className="btn btn-lg" style={{ background: "rgba(255,255,255,0.15)", color: "white", border: "1.5px solid rgba(255,255,255,0.4)" }}>
              View Paintings
            </Link>
          </div>
        </div>
      ...
      {/* Why Us */}
      <section style={{ background: "#2c1a0e", color: "#e8d5b7", padding: "4rem 0" }}>
        <div className="container">
...
const heroStyles = {
  section: {
    ...
    background: "linear-gradient(135deg, #2c1a0e 0%, #5c3d2e 40%, #c4613a 100%)",
  ...
  content: { position: "relative", zIndex: 1, maxWidth: 1280, margin: "0 auto", padding: "3rem 1.5rem", color: "white" },
  eyebrow: { fontSize: "0.85rem", letterSpacing: "0.15em", textTransform: "uppercase", color: "#d4a017", marginBottom: "1rem", fontWeight: 600 },
  title: {
    fontFamily: "'Playfair Display', serif",
    fontSize: "clamp(2.5rem, 6vw, 5rem)",
    lineHeight: 1.15, marginBottom: "1.25rem", color: "white",
  },
  sub: { fontSize: "1.05rem", color: "#c8a882", maxWidth: 480, marginBottom: "2rem", lineHeight: 1.7 },
...
const catStyles = {
  ...
  card: {
    background: "white", border: "1px solid #e0cdb8", borderRadius: 12,
  ...
  icon: { fontSize: "2rem" },
  label: { fontSize: "0.85rem", fontWeight: 600, color: "#5c3d2e" },
};
...
const whyStyles = {
  ...
  desc: { fontSize: "0.88rem", color: "#a08060", lineHeight: 1.6 },
};